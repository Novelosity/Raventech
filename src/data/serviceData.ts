...
const metaAds: ServiceData = {
  ...
  portfolio: [
    { id: 'meta-1', title: 'E-Commerce Catalog Ads — Fashion', client: 'Sample / Concept — Fashion E-Commerce', niche: 'Fashion', filter: 'E-com/Catalog', metric: '5.2x ROAS', thumbnailGradient: 'from-violet-700 to-purple-900', image: '/images/WEbsite%20digital%20marketing/Meta%20ads/Ecommerce%20fashion%20brand.png', challenge: 'A fashion brand\'s dynamic catalog ads were generating 1.8x ROAS — below the 2.5x break-even threshold. Creative was static and audience targeting was broad.', approach: 'Rebuilt catalog creative templates with lifestyle overlays, restructured audiences around 180-day purchaser lookalikes, and implemented a 7-day recency retargeting sequence.', result: '5.2x ROAS at scale ($15K/mo spend); CPA dropped 38% while maintaining volume.', metrics: [{ label: 'ROAS', value: '5.2x' }, { label: 'CPA Reduction', value: '-38', unit: '%' }, { label: 'Monthly Spend', value: '$15K' }], tools: ['Meta Ads Manager', 'Northbeam', 'Canva', 'Klaviyo'], hasBeforeAfter: false },
    { id: 'meta-2', title: 'Lead Gen Campaigns — Real Estate', client: 'Sample / Concept — Real Estate', niche: 'Real Estate', filter: 'Lead Gen', metric: '−38% CPA', thumbnailGradient: 'from-blue-700 to-indigo-900', image: '/images/WEbsite%20digital%20marketing/Meta%20ads/Lead%20Generation%20real%20state.png', challenge: 'A real estate developer\'s lead gen campaigns were generating expensive leads at $84 CPL — the industry average for their market was $45.', approach: 'Rewrote lead form questions to qualify intent, rebuilt audiences around in-market housing signals, and A/B tested 6 creative concepts against the control.', result: 'CPL dropped from $84 to $31 within 60 days; qualified lead quality score (internal) increased from 54% to 79%.', metrics: [{ label: 'CPL Reduction', value: '$84→$31' }, { label: 'Lead Quality Score', value: '79', unit: '%' }, { label: 'Creative Variants Tested', value: '6' }], tools: ['Meta Ads Manager', 'Zapier', 'HubSpot'], hasBeforeAfter: false },
    { id: 'meta-3', title: 'UGC-Style Retargeting — Supplements', client: 'Sample / Concept — Health Supplements', niche: 'Supplements', filter: 'UGC', metric: '2.1% CTR', thumbnailGradient: 'from-green-700 to-emerald-900', image: '/images/WEbsite%20digital%20marketing/Meta%20ads/UGC%20RETARGETING%20-%20SUPPLIMENTS.png', challenge: 'A supplement brand\'s retargeting ads had exhausted their creative and were seeing severe ad fatigue — CTR had fallen from 1.9% to 0.4% over 6 weeks.', approach: 'Produced 12 UGC-style video ads with 4 different hooks, introduced a 3-day creative rotation rule, and segmented audiences by days-since-visit.', result: 'Average CTR across retargeting campaigns returned to 2.1%; ROAS on retargeting improved from 2.1x to 7.4x.', metrics: [{ label: 'CTR', value: '2.1', unit: '%' }, { label: 'Retargeting ROAS', value: '7.4x' }, { label: 'UGC Variants', value: '12' }], tools: ['Meta Ads Manager', 'MotionApp', 'CapCut'], hasBeforeAfter: false },
  ],
  faq: [
